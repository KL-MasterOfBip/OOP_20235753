...
import hust.soict.hedspi.aims.screen.manager.AddBookToStoreScreen.AddNewBook;
...
public class AddDigitalVideoDiscToStoreScreen extends JFrame{
	...
	public AddDigitalVideoDiscToStoreScreen (Store store) {
		...
		add.addActionListener(new AddNewDVD());
		input.add(add);
		cp.add(input);
	...
	public class AddNewDVD implements ActionListener {
	    @Override
	    public void actionPerformed(ActionEvent e) {
	    	DigitalVideoDisc DVD = new DigitalVideoDisc();
	    	DVD.setTitle(in_title.getText());
	    	DVD.setCategory(in_category.getText());
	        try {
	        	DVD.setCost(Float.parseFloat(in_cost.getText()));
