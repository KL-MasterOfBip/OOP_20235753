...
public class AddCompactDiscToStoreScreen extends JFrame{
	...
	public AddCompactDiscToStoreScreen (Store store) {
		...
		JButton add = new JButton("Add new CD");
		add.addActionListener(new AddNewCD());
		input.add(add);
		cp.add(input);
	...
	public class AddNewCD implements ActionListener {
	    @Override
	    public void actionPerformed(ActionEvent e) {
	        CompactDisc CD = new CompactDisc();
	        CD.setTitle(in_title.getText());
	        CD.setCategory(in_category.getText());
	        try {
	            CD.setCost(Float.parseFloat(in_cost.getText()));
